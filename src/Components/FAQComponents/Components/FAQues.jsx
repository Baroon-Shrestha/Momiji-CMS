...
export default function FAQues() {
  const { faqs } = useFaqSection("faq4"); // loads from faq4.en.md or faq4.ja.md
    ...
    <div className="container mx-auto py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-extralight">
          Got questions? Explore common queries about studying in Japan, visa
          processing, scholarships, and more—answered clearly.
        </p>
      </div>
